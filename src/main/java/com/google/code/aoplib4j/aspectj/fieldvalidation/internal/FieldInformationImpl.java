 ...
 *
 */
final class FieldInformationImpl implements FieldInformation {
    
    /**
     * the logger to use.
     */
    private static Logger logger = Logger.getLogger(
            FieldInformationImpl.class.getName());
     ...
     */
     FieldInformationImpl(final Object fldValue, final Object valueToAssign,
            final boolean staticFld, final String fldName) {
        super();
        logger.info("Creating instance of " 
                + FieldInformationImpl.class.getName());
