...
public class JUnit3Test extends TestCase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        System.setProperty(
                VerifyAspect.AOPLIB4J_FAIL_INHIBIT, 
                VerifyAspect.AOPLIB4J_FAIL_INHIBIT_VALUE);
    }
     ...
     * {@link VerifyAspect#AOPLIB4J_FAIL_INHIBIT} property have the value 
     * {@link VerifyAspect#AOPLIB4J_FAIL_INHIBIT_VALUE} the failures are 
     * inhibited.
     */
