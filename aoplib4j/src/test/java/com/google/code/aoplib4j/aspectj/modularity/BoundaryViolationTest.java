...
public class BoundaryViolationTest extends TestCase {
     ...
     * call the methods from the {@link CalledClass}.
     */
     ...
     * methods from the {@link CalledClass} that calls methods from the
     * {@link CalledClass}.
     */
    public final void testBoundaryOkOnSameClass() {
        cc.callerCalledMethod();
        
        CalledClass.callerCalledStaticMethod();
    }
